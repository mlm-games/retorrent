...
internal object CertificateVerifier {
    ...
    private fun verifyCertificateChain(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            // at the end-entity depth. We will prefer CRLs over OCSP to ensure certificates without
            // an OCSP responder URL (e.g. Let's Encrypt certificates issued after their OCSP deprecation)
            // are not incorrectly rejected. If CRL checking fails, we do not fall back to OCSP.
            // We allow "soft" failures, for example transient network errors.
            //
